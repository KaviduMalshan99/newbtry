                    ...
                    <div class="card-body">
                        ...
                        <form id="repairForm" action="{{ route('repairs.store') }}" method="POST">
                            ...
                            {{-- <div class="mb-4">
                                ...
                                <input type="textarea" name="diagnostic_report" placeholder="Type here" class="form-control"
                                    id="diagnostic_report" />
                            </div>

                            <div class="mb-4">
                                <label for="items_used" class="form-label">Items Used</label>
                                <input type="textarea" name="items_used" placeholder="Type here" class="form-control"
                                    id="items_used" />
                            </div>
                            <div class="row gx-3">
                                <div class="col-md-6 mb-4">
