...
<div class="container-fluid basic_table">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ isset($battery) ? 'Edit Battery' : 'Add New Battery' }}</h4>
                    <form
                      ...
                      <div class="row">
                        ...
                        <div class="form-group  my-3">
                            ...
                            <input type="file" name="image" class="form-control" {{ isset($battery) ? '' : 'required' }}>
                            @if(isset($battery) && $battery->image)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $battery->image) }}" alt="Battery Image" width="100">
                                </div>
                            @endif
                            @error('image')
                                <small class="text-danger">{{ $message }}</small>
