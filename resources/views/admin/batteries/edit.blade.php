    ...
    <form action="{{ route('batteries.update', $battery->id) }}" method="POST">
        ...
        <div class="form-group my-2">
            ...
            <input 
                ...
                name="model_name" 
                class="form-control" 
                value="{{ old('model_name', $battery->model_name) }}" 
                required
            >
        </div>
        ...
        <div class="form-group my-2">
            ...
            <input 
                ...
                name="capacity" 
                class="form-control" 
                value="{{ old('capacity', $battery->capacity) }}" 
                required
            >
        </div>
        ...
        <div class="form-group my-2">
            <label for="battery_type" class="mb-2">Battery Type</label>
            <input 
                type="text" 
                name="battery_type" 
                class="form-control" 
        ...
        <div class="form-group my-2">
            ...
            <input 
                ...
                class="form-control" 
                value="{{ old('warranty_period', $battery->warranty_period) }}" 
                required
            >
        </div>
        ...
        <div class="form-group my-2">
            ...
            <input 
                ...
                class="form-control" 
                step="0.01" 
                value="{{ old('purchase_price', $battery->purchase_price) }}" 
                required
            >
        </div>
        ...
        <div class="form-group my-2">
            ...
            <input 
                ...
                class="form-control" 
                step="0.01" 
                value="{{ old('selling_price', $battery->selling_price) }}" 
                required
            >
        </div>
        ...
        <div class="form-group my-2">
            ...
            <input 
                ...
                name="stock_quantity" 
                class="form-control" 
                value="{{ old('stock_quantity', $battery->stock_quantity) }}" 
                required
            >
        </div>
        ...
        <div class="form-group my-2">
            ...
            <input 
                ...
                name="added_date" 
                class="form-control" 
                value="{{ old('added_date', $battery->added_date) }}" 
                required
            >
        </div>
