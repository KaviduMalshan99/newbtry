...
@section('content')
    <div class="container-fluid">
        <div class="row widget-grid">
            ...
            @php
                $balanceStats = app(\App\Http\Controllers\MainPosController::class)->getBalanceStatistics();
            @endphp
                                        ...
                                        <div class="light-card balance-card widget-hover">
                                            ...
                                            <div class="ms-auto text-end">
                                                <div class="dropdown icon-dropdown">
                                                    ...
                                                    class="">{{ $balanceStats['expense']['change'] >= 0 ? '+' : '-' }}${{ number_format(abs($balanceStats['earnings']['change'])) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-md-4">
