    ...
    public function storeOrderLubricant(Request $request)
    {
        ...
        try {
            ...
            $orderId = DB::table('lubricant_orders')->insertGetId([
                ...
                'items' => $validatedData['total_items'],
                'all_id' => $validatedData['all_id'],
                'lubricant_discount' => 0, // Default discount
                'subtotal' => $validatedData['total_price'], // Assuming subtotal is the same as total_price
                ...
                'measurement' => $validatedData['unit'], // Fixed column name
